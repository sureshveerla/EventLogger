...
namespace {
struct qt_meta_tag_ZN16KavachPktHandlerE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN16KavachPktHandlerE = QtMocHelpers::stringData(
    "KavachPktHandler",
    "logToDB",
    "",
    "message",
    ...
    "senderPort",
    "datagram",
    "SigPreviousFaultInfo",
    "SigStationConnStatus",
    "enqueuePacket"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN16KavachPktHandlerE[] = {
...
Q_CONSTINIT const QMetaObject KavachPktHandler::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_ZN16KavachPktHandlerE.offsetsAndSizes,
    qt_meta_data_ZN16KavachPktHandlerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16KavachPktHandlerE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<KavachPktHandler, std::true_type>,
        // method 'logToDB'
        ...
        // method 'SigPreviousFaultInfo'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'SigStationConnStatus'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void KavachPktHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (KavachPktHandler::*)(QString );
            if (_q_method_type _q_method = &KavachPktHandler::logToDB; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (KavachPktHandler::*)(QString );
            if (_q_method_type _q_method = &KavachPktHandler::updatePrompt; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (KavachPktHandler::*)(QHostAddress , quint16 );
            if (_q_method_type _q_method = &KavachPktHandler::sendAck; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (KavachPktHandler::*)(QString );
            if (_q_method_type _q_method = &KavachPktHandler::sendSMS; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _q_method_type = void (KavachPktHandler::*)(QHostAddress , quint16 , QByteArray );
            if (_q_method_type _q_method = &KavachPktHandler::SigNewFaultPacket; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _q_method_type = void (KavachPktHandler::*)();
            if (_q_method_type _q_method = &KavachPktHandler::SigPreviousFaultInfo; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _q_method_type = void (KavachPktHandler::*)();
            if (_q_method_type _q_method = &KavachPktHandler::SigStationConnStatus; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
...
void *KavachPktHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16KavachPktHandlerE.stringdata0))
