...
struct qt_meta_stringdata_CLASSKavachPktHandlerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSKavachPktHandlerENDCLASS = QtMocHelpers::stringData(
    "KavachPktHandler",
    "logToDB",
    "",
    "message",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSKavachPktHandlerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject KavachPktHandler::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSKavachPktHandlerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSKavachPktHandlerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSKavachPktHandlerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void KavachPktHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &KavachPktHandler::logToDB; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (KavachPktHandler::*)(QString );
            if (_t _q_method = &KavachPktHandler::updatePrompt; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &KavachPktHandler::sendAck; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (KavachPktHandler::*)(QString );
            if (_t _q_method = &KavachPktHandler::sendSMS; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &KavachPktHandler::SigNewFaultPacket; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &KavachPktHandler::SigPreviousFaultInfo; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (KavachPktHandler::*)();
            if (_t _q_method = &KavachPktHandler::SigStationConnStatus; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
...
void *KavachPktHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSKavachPktHandlerENDCLASS.stringdata0))
